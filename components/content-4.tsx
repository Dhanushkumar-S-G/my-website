            ...
            <div className="mx-auto px-6">
                <div className="grid md:grid-cols-2 md:gap-12 gap-8">
                    ...
                    <div className="space-y-6">
                        <p>I am a software engineer with a strong interest on <span className="font-bold">distributed systems and databases</span>. I currently work as a Software Development Engineer at <Link href="https://www.amazon.com" className="brand-link">Amazon</Link>, where I design and build network monitoring systems that operate at scale.</p>
                        <p>
                            Previously, I interned at a startup called <Link href="https://www.appviewx.com" className="brand-link">AppViewX</Link> as part of the Install and Upgrade team where I developed a <span className="font-bold">lightweight prerequisite assessment tool</span> for Kubernetes cluster nodes that checks if tools and
configurations are ready, reports issues, and suggests fixes, reducing installation issues by up to <span className="font-bold">65%</span>.
                        ...
                        <AnimatedShinyButton url='/more-about-me'>More about me</AnimatedShinyButton>
                    </div>
                </div>
            </div>
        </section>
